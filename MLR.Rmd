...
```{r, eval=FALSE, echo=FALSE}
setwd("~")
if(any(strsplit(Sys.info()[4], "\\.")[[1]] %in% "washington")){ROOT_DIR="~/"} else (ROOT_DIR="~/share0/Lab Members/Scott/AWS/Scott/")
if(any(strsplit(Sys.info()[4], "\\.")[[1]] %in% "MacDude")){ROOT_DIR="/Volumes/UW/"}
key<-"Jan2017"
```
...
## The MLR through the lens of single-cell RNA-seq
- Dividing T cells will dilute out the green label (CFSE) and can be quantified flow cytometrically
